...
case class OrdersOperatorManager() extends AbstractTableOperatorManager {
  ...
  override val typeSchema: String = "(f => (f(0).toInt, f(1).toInt, f(2), f(3).toFloat, java.sql.Date.valueOf(f(4)), f(5), f(6), f(7).toInt, f(8)))"//"(Int, Int, String, Float, java.sql.Date, String, String, Int, String)"
